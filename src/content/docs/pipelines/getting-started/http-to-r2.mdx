...
Pipeline lets you ingest and load real time data streams such as website clicks or logs into [R2 Object Storage](/r2/). This guide will show you how to setup a Pipeline which accepts data via HTTP.
