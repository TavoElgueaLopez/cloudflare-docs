---
title: Build a Worker to R2 Pipeline
pcx_content_type: concept
sidebar:
  order: 2
head:
  - tag: title
    content: Build a Worker to R2 Pipeline
---

import { Render, PackageManagers } from "~/components";

Pipelines let you ingest and load real time data streams such as website clicks or logs into [R2 Object Storage](/r2/). This guide will show you how to setup a Pipeline, and send records to your Pipeline from a [Cloudflare Worker](/workers/)
